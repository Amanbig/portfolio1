...
import { SiTailwindcss, SiNextdotjs, SiFlutter, SiPython, SiC, SiCplusplus, SiUnity, SiBlender } from 'react-icons/si';
...
const experience = {
  ...
  items: [
    { company: "HactoberFest", position: "Participated in Open source Contributions", duration: "2021 - Present" },
...
const skills = {
  ...
  skillList: [
    ...
    { icon: <SiUnity />, name: "Next.js" },
    { icon: <SiBlender />, name: "Next.js" }
  ]
};
